...
export default function RightArrow({ size = 30 }) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
      ...
      style="enable-background:new 0 0 493.464 493.464;"
      xmlSpace="preserve"
      style={{
        width: `${size}px`,
        height: `${size}px`,
    ...
    >
      <g>
        <g>
          <path
            d="M246.734,0C110.69,0,0.01,110.684,0.01,246.736c0,136.04,110.68,246.728,246.728,246.728
