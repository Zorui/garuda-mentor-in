...
export default function LeftArrow({ size = 30 }) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
      ...
      style="enable-background:new 0 0 493.468 493.468;"
      xmlSpace="preserve"
      style={{
        width: `${size}px`,
        height: `${size}px`,
    ...
    >
      <g>
        <g>
          <path
            d="M246.73,0C110.682,0,0.01,110.688,0.01,246.736c0,136.044,110.672,246.732,246.72,246.732S493.458,382.78,493.458,246.736
